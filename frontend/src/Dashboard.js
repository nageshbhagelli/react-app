...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow pt-6 px-6 max-w-7xl mx-auto w-full">
        {/* Welcome Banner */}
        ...
        <section className="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-xl shadow-xl text-white p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <ul>
                <li className="flex justify-between py-2 border-b border-indigo-400 font-bold">
                  NIFTY 50
            ...
            <div>
              ...
              <ul>
                <li className="flex justify-between py-2 border-b border-indigo-400">
                  RELIANCE{" "}
                  <span className="text-green-300 font-semibold">+2.5%</span>
                </li>
                <li className="flex justify-between py-2 border-b border-indigo-400">
                  TCS{" "}
                ...
                <li className="flex justify-between py-2 border-b border-indigo-400">
                  INFY{" "}
                  <span className="text-green-300 font-semibold">+1.2%</span>
                </li>
              </ul>
            </div>
          </div>
